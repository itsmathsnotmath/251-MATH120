...
\date{Due Monday, September 30th 2024} % The due date of the assignment. All assignemets are dues at 11:59pm on the date listed
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                                                              %
...
\begin{itemize}
    ...
    \item \href{https://bit.ly/4gxMEGA}{\textbf{Duplicate this \texttt{.tex} file in Overleaf}}.
