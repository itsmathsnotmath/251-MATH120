...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
\title{\textbf{MATH-UA 120 Discrete Mathematics: \\ Polished Proof 2 - Revised Draft}}
\author{%
    Peter Rabbit % Change to your name!
}
\date{Due Monday, November 18th, 2024} % The due date of the assignment. All assignemets are dues at 11:59pm on the date listed
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                                                              %
...
\begin{itemize}
    ...
    \item \href{https://bit.ly/4eelGSd}{\textbf{Click here to duplicate this \texttt{.tex} file in Overleaf}}.
