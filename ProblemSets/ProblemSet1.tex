...
Interpret Definition and Theorem
...
Write the following statements as if-then statements. Then decide if the statements are true or false. (You don't need to justify why they are true or false).
