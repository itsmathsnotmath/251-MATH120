...
\section*{Problem 7}
Give a combinatorial proof of the identity $$3^n-1=1\cdot3^0+2\cdot3^1+2\cdot3^2+\cdots+2\cdot3^{n-1}.$$ You may not manipulate the question algebraically. Only a combinatorial proof will be accepted.
\begin{solution}
