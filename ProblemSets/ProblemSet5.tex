...
\section*{Problem 7}
Let $n\in\mathbb{N}$. Use induction to prove that $\displaystyle\binom{2n}{n}<2^{2n-2}$ for all $n\geq5$.
\begin{solution}
...
\section*{Problem 8}
Let $n\in\mathbb{Z}$. Use induction to prove that $3\mid\left(n^3+2n\right)$. \medskip

\noindent\emph{Note: we want to prove the xlaim for all integers, not just natural numbers.}
\begin{solution}
