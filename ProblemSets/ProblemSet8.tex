...
4+\cfrac{1}{2+\cfrac{1}{1+\cfrac{1}{4+0}}}.$$ Use this example and part (a) to write the continued fraction for $\dfrac{2024}{314}$.

            \vfill
                \begin{align*}
                    2024 & = 6\left(314\right)+140 \\
                     314 & = 2\left(140\right)+34 \\
                     140 & = 4\left(34\right)+4 \\
                      34 & = 8\left(4\right)+2 \\
                       4 & = 2\left(2\right)+0
                \end{align*}
                So, $$\mathrm{\frac{2024}{314}}=
6+\cfrac{1}{2+\cfrac{1}{4+\cfrac{1}{8+\cfrac{1}{2+0}}}}.$$
            \vfill

            Why do we care about continued fractions? They give us rational approximations for numbers. For example, $\pi$ has a continued fraction that never terminates: $$\mathrm{\dfrac{\pi}{1}}=
3+\cfrac{1}{7+\cfrac{1}{15+\cfrac{1}{\cdots}}}.$$ \emph{Truncating} the continued fraction after just two steps gives us a common approximation for $\pi$: $\pi\approx3+\cfrac{1}{7}=\dfrac{22}{7}$.
\end{enumerate}
